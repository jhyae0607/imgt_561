...
class MetadataTransformer:
    ...
    converts the input to pandas dataframe, converts datetime data to PDT to EST,
    replaces empty or '[]' data to 'None', returns the cleaned data as pandas dataframe'''
